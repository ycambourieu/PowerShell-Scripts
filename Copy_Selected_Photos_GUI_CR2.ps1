<#
    ...
    Date : 30/08/2019
    Script : Copy_Selected_Photos_GUI_CR2.ps1
    Version : 1.0
    Utility : Copy a list of CR2 files into a seperated directory for editing purposes
    Compatible Plateform : Windows 10, CANON img CR2 Files
    Usage : 
        - Select the forlder of source RAW CR2 files
        ...
        This will copy files IMG_5433.CR2, IMG_5622.CR2, IMG_5625.CR2 files from source to destination folder
#>
...
foreach($line in Get-Content -Path $file){
    ...
    Copy-Item -Path $SOURCE\IMG_$line.CR2 -Destination "$DESTINATION\"
}